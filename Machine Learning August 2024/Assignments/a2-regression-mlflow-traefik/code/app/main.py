...
app.add_event_handler("startup", start_app_handler(app, settings.MODEL_PATH, settings.MODEL_PATH2, settings.X_scaler_path, settings.Y_scaler_path, settings.rf_scaler_path))
